...
export default function Header() {
	...
	return (
		<header className="z-[999] relative">
			<motion.div
				className="fixed mt-2 top-0 left-1/2 -translate-x-1/2 h-[4.5rem] w-[95%] rounded-full border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-gray-950/80 dark:border-black/30 md:block hidden"
			...
			{/* Desktop navigation */}
			<nav className="fixed mt-2 top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0 md:flex hidden">
